...
privileged aspect PermissionBean_Roo_ManagedBean {
    
    declare @type: PermissionBean: @ManagedBean(name = "permissionBean");
    
    declare @type: PermissionBean: @SessionScoped;
    
    private String PermissionBean.name = "Permissions";
    
    private Permission PermissionBean.permission;
    
    private List<Permission> PermissionBean.allPermissions;
    
    private boolean PermissionBean.dataVisible = false;
    
    private List<String> PermissionBean.columns;
    
    private HtmlPanelGrid PermissionBean.createPanelGrid;
    
    private HtmlPanelGrid PermissionBean.editPanelGrid;
    
    private HtmlPanelGrid PermissionBean.viewPanelGrid;
    
    private boolean PermissionBean.createDialogVisible = false;
    
    @PostConstruct
    public void PermissionBean.init() {
    ...
    public String PermissionBean.getName() {
        return name;
    }
    
    public List<String> PermissionBean.getColumns() {
        return columns;
    }
    
    public List<Permission> PermissionBean.getAllPermissions() {
        return allPermissions;
    }
    
    public void PermissionBean.setAllPermissions(List<Permission> allPermissions) {
        this.allPermissions = allPermissions;
    }
    
    public String PermissionBean.findAllPermissions() {
        allPermissions = Permission.findAllPermissions();
        dataVisible = !allPermissions.isEmpty();
        return null;
    }
    
    public boolean PermissionBean.isDataVisible() {
        return dataVisible;
    }
    
    public void PermissionBean.setDataVisible(boolean dataVisible) {
        this.dataVisible = dataVisible;
    }
    
    public HtmlPanelGrid PermissionBean.getCreatePanelGrid() {
    ...
    public void PermissionBean.setCreatePanelGrid(HtmlPanelGrid createPanelGrid) {
        this.createPanelGrid = createPanelGrid;
    }
    
    public HtmlPanelGrid PermissionBean.getEditPanelGrid() {
    ...
    public void PermissionBean.setEditPanelGrid(HtmlPanelGrid editPanelGrid) {
        this.editPanelGrid = editPanelGrid;
    }
    
    public HtmlPanelGrid PermissionBean.getViewPanelGrid() {
    ...
    public void PermissionBean.setViewPanelGrid(HtmlPanelGrid viewPanelGrid) {
        this.viewPanelGrid = viewPanelGrid;
    }
    
    public HtmlPanelGrid PermissionBean.populateCreatePanel() {
        ...
        updateTimeCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.updateTime}", Date.class));
        ...
        updatedByCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.updatedBy}", User.class));
        updatedByCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{permissionBean.completeUpdatedBy}", List.class, new Class[] { String.class }));
        ...
        creationTimeCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.creationTime}", Date.class));
        ...
        createdByCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.createdBy}", User.class));
        createdByCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{permissionBean.completeCreatedBy}", List.class, new Class[] { String.class }));
        ...
        nameCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.name}", String.class));
    ...
    public HtmlPanelGrid PermissionBean.populateEditPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        updateTimeEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.updateTime}", Date.class));
        ...
        updatedByEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.updatedBy}", User.class));
        updatedByEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{permissionBean.completeUpdatedBy}", List.class, new Class[] { String.class }));
        ...
        creationTimeEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.creationTime}", Date.class));
        ...
        createdByEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.createdBy}", User.class));
        createdByEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{permissionBean.completeCreatedBy}", List.class, new Class[] { String.class }));
        ...
        nameEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.name}", String.class));
    ...
    public HtmlPanelGrid PermissionBean.populateViewPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        updateTimeValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.updateTime}", Date.class));
        ...
        updatedByValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.updatedBy}", User.class));
        ...
        creationTimeValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.creationTime}", Date.class));
        ...
        createdByValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.createdBy}", User.class));
        ...
        nameValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{permissionBean.permission.name}", String.class));
        htmlPanelGrid.getChildren().add(nameValue);
        
        return htmlPanelGrid;
    }
    
    public Permission PermissionBean.getPermission() {
        if (permission == null) {
    ...
    public void PermissionBean.setPermission(Permission permission) {
        this.permission = permission;
    }
    
    public List<User> PermissionBean.completeUpdatedBy(String query) {
    ...
    public List<User> PermissionBean.completeCreatedBy(String query) {
        List<User> suggestions = new ArrayList<User>();
        for (User user : User.findAllUsers()) {
            String userStr = String.valueOf(user.getUpdateTime() +  " "  + user.getCreationTime() +  " "  + user.getUsername() +  " "  + user.getName());
            if (userStr.toLowerCase().startsWith(query.toLowerCase())) {
    ...
    public String PermissionBean.onEdit() {
        return null;
    }
    
    public boolean PermissionBean.isCreateDialogVisible() {
        return createDialogVisible;
    }
    
    public void PermissionBean.setCreateDialogVisible(boolean createDialogVisible) {
        this.createDialogVisible = createDialogVisible;
    }
    
    public String PermissionBean.displayList() {
        createDialogVisible = false;
        findAllPermissions();
        return "permission";
    }
    
    public String PermissionBean.displayCreateDialog() {
        permission = new Permission();
        createDialogVisible = true;
        return "permission";
    }
    
    public String PermissionBean.persist() {
        String message = "";
    ...
    public String PermissionBean.delete() {
        permission.remove();
    ...
    public void PermissionBean.reset() {
        permission = null;
        createDialogVisible = false;
    }
    
    public void PermissionBean.handleDialogClose(CloseEvent event) {
        reset();
    }
